...
namespace Kcsar.Database.Model
{
  ...
  public class Member : ModelObject
  {
      ...
      : base()
    {
      ...
      this.TrainingRosters = new List<TrainingRoster>();
      this.Memberships = new List<UnitMembership>();
      this.ComputedAwards = new List<ComputedTrainingAward>();
      this.Animals = new List<AnimalOwner>();
      this.MissionDetails = new List<MissionDetails>();
      this.ApplyingTo = new List<UnitApplicant>();
      this.EmergencyContacts = new List<MemberEmergencyContact>();
      this.UnitDocuments = new List<MemberUnitDocument>();
    }
